...
1. 备份 Zotero 数据目录，从[3.0.14 发布页](https://github.com/poesein/ZotQuery/releases/tag/v3.0.14)下载 XPI，在 Zotero 插件管理器中从文件安装并重启。3.0.14 可升级同一独立扩展 ID 的 3.0.12/3.0.13；使用旧 ZotSeek ID 的早期候选版不会原位升级或自动迁移索引。
