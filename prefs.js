...
pref("extensions.zotero.zotseek.lneNative.enabled", true);
pref("extensions.zotero.zotseek.lneNative.autoSync", false);
pref("extensions.zotero.zotseek.lneNative.libraryScope", "user");
pref("extensions.zotero.zotseek.lneNative.noteScope", "all");
pref("extensions.zotero.zotseek.lneNative.titlePattern", "");
pref("extensions.zotero.zotseek.lneNative.semantic", true);
pref("extensions.zotero.zotseek.lneNative.semanticTopK", 150);
pref("extensions.zotero.zotseek.lneNative.semanticMinSimilarityPercent", 35);
pref("extensions.zotero.zotseek.lneNative.semanticRelativeDropPercent", 12);
pref("extensions.zotero.zotseek.lneNative.semanticWeightPercent", 50);
pref("extensions.zotero.zotseek.lneNative.embeddingBatchSize", 8);
pref("extensions.zotero.zotseek.lneNative.duplicateStyle", "bar");

// Default presentation for zotquery_research_render. This never changes gates.
pref("extensions.zotero.zotseek.outputProfile", "standard");
