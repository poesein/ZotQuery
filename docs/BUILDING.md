...
This repository and its public XPI are **3.0.12 pre-release candidates**, not validated Zotero production releases. The ONNX model is stored through Git LFS. Clone with Git LFS installed, then run:
